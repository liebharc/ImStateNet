namespace ImStateNet.Extensions
{
    ...
    public static class LambdaCalcNode
    {
        ...
        public static LambdaBinaryCalcNode<TOUT, TI1, TI2> Create<TOUT, TI1, TI2>(
            ...
            Func<TI1?, TI2?, Task<TOUT?>> calculation,
            string? name = null)
        {
        ...
        public static LambdaTernaryCalcNode<TOUT, TI1, TI2, TI3> Create<TOUT, TI1, TI2, TI3>(
            ...
            Func<TI1?, TI2?, TI3?, Task<TOUT?>> calculation,
            string? name = null)
        {
        ...
        public static LambdaQuinaryCalcNode<TOUT, TI1, TI2, TI3, TI4, TI5> Create<TOUT, TI1, TI2, TI3, TI4, TI5>(
            ...
            Func<TI1?, TI2?, TI3?, TI4?, TI5?, Task<TOUT?>> calculation,
            string? name = null)
        {
        ...
        public static LambdaCalcNode<T> Create<T>(
            ...
            Func<IReadOnlyList<T>, Task<T?>> calculation,
            string? name = null)
        {
    ...
    {
        private readonly Func<IReadOnlyList<T>, Task<T?>> _calculation;

        public LambdaCalcNode(IReadOnlyList<AbstractNode<T>> dependencies, Func<IReadOnlyList<T>, Task<T?>> calculation, string? name = null)
            : base(dependencies, name)
        {
            _calculation = calculation;
        }

        public override Task<T?> Calculate(IReadOnlyList<object?> inputs)
        {
