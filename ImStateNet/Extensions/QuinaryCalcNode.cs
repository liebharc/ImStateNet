namespace ImStateNet.Extensions
{
    ...
    public abstract class QuinaryCalcNode<TOUT, TI1, TI2, TI3, TI4, TI5> : DerivedNode<TOUT>
    {
        ...
        protected abstract Task<TOUT?> Calculation(TI1? value1, TI2? value2, TI3? value3, TI4? value4, TI5? value5);
    }

    public class LambdaQuinaryCalcNode<TOUT, TI1, TI2, TI3, TI4, TI5> : QuinaryCalcNode<TOUT, TI1, TI2, TI3, TI4, TI5>
    {
        private readonly Func<TI1?, TI2?, TI3?, TI4?, TI5?, Task<TOUT?>> _calculation;
        ...
        protected override Task<TOUT?> Calculation(TI1? value1, TI2? value2, TI3? value3, TI4? value4, TI5? value5)
        {
