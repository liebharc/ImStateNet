namespace ImStateNet.Extensions
{
    ...
    public abstract class TernaryCalcNode<TOUT, TI1, TI2, TI3> : DerivedNode<TOUT>
    {
        ...
        protected abstract Task<TOUT?> Calculation(TI1? value1, TI2? value2, TI3? value3);
    }

    public class LambdaTernaryCalcNode<TOUT, TI1, TI2, TI3> : TernaryCalcNode<TOUT, TI1, TI2, TI3>
    {
        private readonly Func<TI1?, TI2?, TI3?, Task<TOUT?>> _calculation;
        ...
        protected override Task<TOUT?> Calculation(TI1? value1, TI2? value2, TI3? value3)
        {
